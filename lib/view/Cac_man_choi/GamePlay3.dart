...
class GamePlay3 extends StatefulWidget {
  const GamePlay3({super.key});
  
  @override
  State<GamePlay3> createState() =>_GamePlay2();
}

class _GamePlay2 extends State<GamePlay3> {
  Color c1 = Color.fromARGB(255, 245, 233, 66);
final user = FirebaseAuth.instance.currentUser;
  List<String> docIDs = [];
  Future getDocId() async{
    await FirebaseFirestore.instance.collection('man4').get().then((snapshot) => snapshot.docs.forEach((element) {
      ...
      Column(mainAxisAlignment: MainAxisAlignment.start, children: [
        ...
        Row(
         ...
         FutureBuilder(
              ...
              return Get_question3(documentId: docIDs[index],);
            },
            );
            })
            ),
