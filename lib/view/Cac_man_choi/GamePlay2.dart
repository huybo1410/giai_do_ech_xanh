...
class GamePlay2 extends StatefulWidget {
  const GamePlay2({super.key});
  
  @override
  State<GamePlay2> createState() =>_GamePlay2();
}
...
final user = FirebaseAuth.instance.currentUser;
  ...
  Future getDocId() async{
    await FirebaseFirestore.instance.collection('man3').get().then((snapshot) => snapshot.docs.forEach((element) {
      ...
      Column(mainAxisAlignment: MainAxisAlignment.start, children: [
        ...
        Row(
         ...
         FutureBuilder(
              ...
              return Get_question2(documentId: docIDs[index],);
            },
            );
            })
            ),
