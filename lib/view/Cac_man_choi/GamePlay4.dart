...
class GamePlay4 extends StatefulWidget {
  const GamePlay4({super.key});
  
  @override
  State<GamePlay4> createState() =>_GamePlay4();
}
...
final user = FirebaseAuth.instance.currentUser;
  ...
  Future getDocId() async{
    await FirebaseFirestore.instance.collection('man5').get().then((snapshot) => snapshot.docs.forEach((element) {
      ...
      Column(mainAxisAlignment: MainAxisAlignment.start, children: [
        ...
        Row(
         ...
         FutureBuilder(
              ...
              return Get_question4(documentId: docIDs[index],);
            },
            );
            })
            ),
