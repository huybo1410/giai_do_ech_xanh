...
class Get_question2  extends StatelessWidget {
  const Get_question2 ({super.key, required this.documentId});
  final String documentId;

  @override
  Widget build(BuildContext context) {
  CollectionReference question = FirebaseFirestore.instance.collection('man3');
