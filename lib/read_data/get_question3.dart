...
class Get_question3  extends StatelessWidget {
  const Get_question3 ({super.key, required this.documentId});
  final String documentId;

  @override
  Widget build(BuildContext context) {
  CollectionReference question = FirebaseFirestore.instance.collection('man4');
